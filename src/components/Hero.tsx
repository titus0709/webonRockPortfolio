...
export default function Hero() {
  return (
    <section className="relative md:py-32 min-h-screen  lg:-top-40 -top-28 " style={{
           backgroundImage: `url(${heroBg.src})`,
        }}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 ">
        <div className="max-w-5xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-7xl lg:mt-14 font-bold text-gray-900 mb-6 leading-tight pt-36">
          ...
          <div className="mt-16 grid grid-cols-3 md:grid-cols-3 gap-8 max-w-3xl mx-auto pb-6">
