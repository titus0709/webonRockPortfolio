  ...
  return (
    <article
      className={`group relative rounded-2xl overflow-hidden bg-white transition-all duration-300 border
        ${hovered
          ? "border-[#F97316]/50 shadow-[0_24px_64px_rgba(0,0,0,0.11)] -translate-y-1"
    ...
    >
      ...
      <div className="p-5 sm:p-6">
        {/* Index label */}
        <p className="text-[#F97316] text-[10px] font-bold uppercase tracking-[0.15em] mb-1.5">
          Project {String(index + 1).padStart(2, "0")}
        </p>

        <h3
          className="text-[#0B1F3A] font-bold leading-tight mb-3 text-lg sm:text-xl"
        ...
        {!project.lighthouse && (
          <div className="flex items-start gap-2.5 bg-[#0B1F3A]/5 border border-[#0B1F3A]/12 rounded-xl px-4 py-3 mb-5">
            <svg className="w-4 h-4 text-[#0B1F3A] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24" aria-hidden="true">
              <polyline points="20 6 9 12 4 10"/>
              <line x1="4" y1="10" x2="4" y2="20"/>
              <line x1="20" y1="6" x2="20" y2="20"/>
              <polyline points="4 20 9 18 20 20"/>
            </svg>
            <p className="text-[#0B1F3A] text-xs font-semibold leading-relaxed">{project.outcome}</p>
          </div>
        )}
        ...
        <a
          ...
          className="inline-flex items-center gap-2 border-2 border-[#0B1F3A] text-[#0B1F3A] font-bold text-sm px-5 py-2.5 rounded-xl hover:bg-[#0B1F3A] hover:text-white active:scale-95 transition-all duration-200 group/btn"
        >
          <ExternalIcon />
    ...
    <section id="work" className="bg-white py-16 sm:py-20 lg:py-28">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          >
            Built to Rank.{" "}
            <span className="text-[#F97316]">Verified by Google.</span>
          </h2>
          <p className="text-gray-500 max-w-xl mx-auto text-sm sm:text-base leading-relaxed px-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#0B1F3A] font-medium underline underline-offset-2 hover:text-[#F97316] transition-colors"
            >
              PageSpeed Insights
            </a>{" "}
        ...
        <div className="max-w-2xl mx-auto mb-10 sm:mb-14 px-0">
          <div className="flex items-start gap-3 bg-[#0B1F3A]/5 border border-[#0B1F3A]/12 rounded-xl px-4 sm:px-5 py-4">
            <svg className="w-4 h-4 text-[#0B1F3A] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
              <circle cx="12" cy="12" r="10"/>
              <line x1="12" y1="8" x2="12" y2="12"/>
              <line x1="12" y1="16" x2="12.01" y2="16"/>
            </svg>
            <p className="text-[#0B1F3A]/80 text-xs sm:text-sm leading-relaxed">
              These are our existing clients — not USA companies yet. We're making our first
        ...
        <div className="text-center border-t border-gray-100 pt-10 sm:pt-12">
          <p className="text-gray-700 font-semibold text-base sm:text-lg mb-2">
            Want these scores — built for your USA business?
          </p>
          ...
          <a
            href={`https://wa.me/919566515735?text=${encodeURIComponent(
              "Hi! I saw your portfolio and Google scores. I want to discuss a website for my USA business."
            )}`}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2.5 sm:gap-3 bg-[#F97316] text-[#0a3d22] font-bold text-sm sm:text-base px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl shadow-[0_4px_20px_rgba(212,175,55,0.35)] hover:brightness-105 hover:-translate-y-0.5 active:scale-95 transition-all duration-150"
          >
            ...
            <span>Discuss Your USA Project on WhatsApp</span>
            <ArrowRight />
          </a>
